...
public:
	...
	void writeToString()
	{
		...
		for (pos = 0; pos < 16; pos++)
			...
			// Commented out line was changed to use secure version to prevent the error bellow
			// Code C4996: 'sprintf:' This functn / varia may be unsafe consider using sprintf_s
			//sprintf(digestChars + (pos * 2), "%02x", digestRaw[pos]);
			sprintf_s(this->digestChars + (pos * 2), 3, "%02x", this->digestRaw[pos]);
	}
...
public:
	...
	char* digestFile(char *filename)
	{
		...
		// Commented out line was changed to use secure version to prevent the error bellow
		// Code C4996: 'fopen:' This functn / varia may be unsafe consider using fopen_s
